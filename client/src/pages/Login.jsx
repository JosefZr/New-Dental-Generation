    ...
    >
      ...
      <div className="absolute inset-0 max-h-[100vh] overflow-y-auto pt-inset-top pb-inset-bottom flex flex-col items-center justify-between">
        <div className="flex flex-col items-center">
          <img src="https://app.jointherealworld.com/icons/logo-512.png" alt="logo" className='mx-auto mt-[30%] h-[256px] max-h-[35vh] w-auto'/>
          <h2 className='mt-[10%] text-center font-bold text-[30px] text-white uppercase'>The Real World</h2>
        </div>
        <div className='w-full max-w-[500px] p-8'>
          <button className='btn font-normal normal-case btn-lg btn-ghost btn-block'onClick={()=>navigate('/sign-up')}>I don&rsquo;t have an account</button>
          {/* <Link to={"/login"}>
          ...
          <div className='relative z-10 mx-auto mt-2 flex max-w-[500px] flex-col overflow-auto rounded-xl bg-base-100 p-6 shadow-lg md:mt-24'>
            <div className='w-full max-w-[95vw] text-center md:max-w-md'>
              <div className=' text-center font-bold text-xl'>Sign in to your account</div>
                <form action="#" className="form-control mt-4 flex flex-col" onSubmit={handleSubmit}>
                  ...
                  <Link to="/" className='mt-3 self-start text-purple-800 text-xs'>Forgot your password?</Link>
