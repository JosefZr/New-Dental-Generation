...
export default function SerachModal() {
        ...
        <DrawerHeader className=" p-0 gap-0 rounded-t-lg bg-transparent overflow-hidden">
            <div className="px-2 " style={{backgroundColor:"rgb(29 41 50)"}}>
                <div className=" w-full " style={{position:"relative"}}>
                    <FaSearchDollar height="24px" width="24px" style={{position:"absolute"}} className=" top-0 bottom-0 left-2 z-10 m-auto text-gray-300"/>
            ...
            <div className="h-[80dvh] overflow-auto bg-alt-base-200 pb-10" style={{
                ...
                filteredCourses.map((course) => (
                    ...
                    onClick={() => {
                        navigate(`/course/details/${course._id}`); // Navigate to course details
                        onClose(); // Close modal
                    }}
                    >
